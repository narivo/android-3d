...
aevv_graphics::Shader* ourShader;
aevv_graphics::Model* ourModel;
aevv_graphics::Animator* animator;
aevv_graphics::Animation* danceAnimation;
...
// camera
aevv_graphics::Camera camera(glm::vec3(0.0f, 0.0f, 3.0f));
...
Java_com_example_webviewar_Renderer_nativeSurfaceCreated(JNIEnv *env, jobject thiz) {
    ...
    ourShader = new aevv_graphics::Shader("vertex.glsl", "fragment.glsl");
    ourModel = new aevv_graphics::Model("ballerina/ballerina_chapeau.dae");

    danceAnimation = new aevv_graphics::Animation("ballerina/ballerina_chapeau.dae", ourModel);
    animator = new aevv_graphics::Animator(danceAnimation);
