...
extern "C" {
JNIEXPORT void JNICALL Java_com_example_webviewar_GLES3JNILib_init(JNIEnv* env, jclass obj);
JNIEXPORT void JNICALL Java_com_example_webviewar_GLES3JNILib_resize(JNIEnv* env, jclass obj, jint width, jint height);
JNIEXPORT void JNICALL Java_com_example_webviewar_GLES3JNILib_step(JNIEnv* env, jclass obj);
};
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_webviewar_GLES3JNILib_resize(JNIEnv* env, jclass obj, jint width, jint height) {
    if (g_renderer) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_webviewar_GLES3JNILib_step(JNIEnv* env, jclass obj) {
    if (g_renderer) {
        g_renderer->render();
    }
}